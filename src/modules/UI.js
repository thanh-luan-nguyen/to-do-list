...
export default class UI {
    ...
    static initSubmitAddProject() {
        document.querySelector('[submit-add-project]')
    ...
    static initButtonProject(projectName) {
        ...
        const project = projects.find(project => project.querySelector('span').innerText === projectName);

        project.addEventListener('click', () => { UI.loadProject(projectName) })
        return project
    }
    static loadProject(projectName) {
        ...
        if (projectName !== "All" && projectName !== "Today" && projectName !== "This Week") UI.initDeleteProjectButton()
        UI.initSortButton();
    ...
    static loadProjectPageContentToUI(projectName) {
        ...
        projectContentPage.innerHTML += `
            <div class="view-as d-flex justify-content-between">
                ...
                <div class="dropstart">
                    <button type="button" class="btn dropdown-toggle shadow-none " data-bs-toggle="dropdown"><span>Filter</span>: <em class="me-1" sort-by>${Storage.getFilterOfProject(projectName)}</em></button>
    ...
    static initAllCheckBoxes() {
        ...
        checkboxes.forEach(checkbox => checkbox.addEventListener("change", this.switchDoneStatus));
    }
    ...
    static openEditTask() {
        ...
        (function prepopulateEditTask() {
            ...
            document.querySelector('[edit-task-project-name]').innerText = task.getProjectName()
    ...
    static initSubmitEditTask() {
        document.querySelector('[submit-edit-task]').addEventListener('submit', () => {
